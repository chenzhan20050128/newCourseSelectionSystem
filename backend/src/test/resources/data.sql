...
-- 3. 插入 courses（课程表）
INSERT INTO courses (course_name, credits, description, college, instructor_name, campus, classroom, start_week, end_week, capacity, enrolled_count) VALUES
('数据结构', 4, '基础数据结构课程', '计算机学院', '李强', '本部', 'A101', 1, 16, 60, 1),
('数据库系统', 3, '关系数据库原理与设计', '计算机学院', '李强', '本部', 'A202', 5, 16, 50, 1),
('操作系统', 4, '操作系统原理与实现', '计算机学院', '陈明', '本部', 'A103', 1, 16, 55, 1),
('计算机网络', 3, '网络协议与网络编程', '计算机学院', '陈明', '本部', 'A204', 8, 16, 50, 0),
('编译原理', 4, '编译器设计与实现', '计算机学院', '张伟', '本部', 'A105', 1, 16, 45, 0),
('测试课程一', 3, '测试描述一', '测试学院', '测试教师一', '测试校区', 'T101', 1, 16, 50, 0),
('测试课程二', 2, '测试描述二', '测试学院', '测试教师二', '测试校区', 'T102', 1, 16, 60, 0);
